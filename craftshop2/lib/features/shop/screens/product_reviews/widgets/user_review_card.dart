      ...
      children: [
        Row(
          ...
          children: [
            Row(
              children: [
                const CircleAvatar(backgroundImage: AssetImage(CSImage.user)),
        ...
        Row(
          children: [
            const CSRatingBarIndicator(rating: 4),
            const SizedBox(width: CSSize.spaceBtwItems),
        ...
        const ReadMoreText(
          ...
          moreStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: CSColors.primaryColor),
          lessStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: CSColors.primaryColor),
        ), // ReadMoreText
        const SizedBox(height: CSSize.spaceBtwItems),
